                ...
                <div class="draft-activity" [class.unselected]="!activity.selected">
                  ...
                  <div class="edit-grid">
                    ...
                    @if (activity.savedPlaceId) {
                      <p class="saved-place">⌖ Usará la ubicación de {{ placeName(activity.savedPlaceId) }} al guardarse.</p>
                    }
                  </div>
                </div>
              }
...
export class ItineraryAssistantComponent {
  ...
  placeName(placeId: string): string {
    return this.store.places().find((place) => place.id === placeId)?.name ??
